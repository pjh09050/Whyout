...
case2_sgd_rating_place = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_sgd_place_k40epochs1000.csv')
case2_sgd_rating_product = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_sgd_product_k20epochs1000.csv')
case2_sgd_rating_video = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_sgd_video_k30epochs1000.csv')

# [Case 2] SGD 결과의 user_latent(U) (행동 데이터가 없는 유저를 삭제한 데이터)item_latent(V)
case2_user_latent_place = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_userlatent_place_k40epochs1000.csv')
case2_user_latent_product = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_userlatent_product_k20epochs1000.csv')
case2_user_latent_video = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_userlatent_video_k30epochs1000.csv')

# [Case 2] SGD 결과의 item_latent(V) (행동 데이터가 없는 유저를 삭제한 데이터)
case2_item_latent_place = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_itemlatent_place_k40epochs1000.csv')
case2_item_latent_product = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_itemlatent_product_k20epochs1000.csv')
case2_item_latent_video = pd.read_csv('../Data/whyout_data/sgd_result/del_data/case2_itemlatent_video_k30epochs1000.csv')